...
return require('packer').startup({
  function(use)
    ...
    use { 'm-demare/hlargs.nvim', after = { 'catppuccin' },
    ...
    --UI
    use { "karb94/neoscroll.nvim", keys = { "<C-u>", "<C-d>", "gg", "G" }, config = "require('plugins.scroll')" }
    ...
    use { "christianchiarulli/JABS.nvim", requires = { "kyazdani42/nvim-web-devicons" },
      config = "require('plugins.jabs')" } -- Lua
    ...
    use { "phaazon/hop.nvim", cmd = { "HopWord", "HopChar1" }, config = "require('plugins.hop')" }
    use { 'folke/which-key.nvim', config = "require('plugins.which-key')", event = "BufWinEnter" }
    use { 'nvim-lualine/lualine.nvim', after = 'nvim-gps', config = "require('plugins.lualine')" }
